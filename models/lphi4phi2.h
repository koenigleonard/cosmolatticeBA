#ifndef LPHI4PHI2_H //Usual macro guard to prevent multiple inclusion
#define LPHI4PHI2_H
...
// fldS : The actual object which contains the scalar fields.
  ...
  public:
    ...
    Model<MODELNAME>(parser,runPar.getLatParams(), toolBox, runPar.dt, STRINGIFY(MODELLABEL)) //MODELLABEL is defined in the cmake.
    {
      ...
      beta_sq = parser.get<double>("beta_sq");
   ...
   /////////
    ...
    auto potentialTerms(Tag<2>) // Interaction energy
    {
   ...
   /////////
    ...
    {
      return   pow<3>(fldS(0_c)) + q * fldS(0_c) * pow<2>(fldS(1_c)) + beta_sq * fldS(0_c);
    }
   ...
   /////////
    ...
    {
      return  3 * pow<2>(fldS(0_c)) +  q * pow<2>(fldS(1_c)) + beta_sq;
    }
